...
- ✅ 35 ricette ragionate, normalizzate per **~600 ml**, con **valori nutrizionali stimati**, micronutrienti, benefici e preparazione.
...
└── supabase/
    ...
    └── seed.sql              # dati iniziali (ingredienti + 35 ricette)
```
...
A questo punto l'app funziona **già completamente**, con tutte le 35 ricette: Supabase non è necessario.
...
2. Esegui gli script **in quest'ordine**, copiando il contenuto di ciascun file e premendo **Run**:
   ...
   3. `supabase/seed.sql`    → inserisce ingredienti e le 35 ricette
